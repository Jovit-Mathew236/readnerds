  ...
  return (
    <>
      <div className="px-10 sm:px-20 ">
        <div className="flex flex-col sm:flex-row min-h-[250px] sm:max-h-[500px]">
          ...
          <div className="flex-1 relative">
            <Image
              ...
              height={1200}
              priority
              className="w-[120%] sm:absolute sm:-right-48"
            />
          </div>
        </div>
        ...
        <div className="w-full mt-10">
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-center w-full sm:w-fit gap-4 mt-4">

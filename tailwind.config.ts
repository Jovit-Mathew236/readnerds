...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ["var(--font-tthoves)", "sans-serif"],
        ...
        //   // "tthoves-light": ["var(--font-tthoves-light)", "sans-serif"],
        //   // "tthoves-thin": ["var(--font-tthoves-thin)", "sans-serif"],
        /* cspell:enable */
      },
      fontSize: {
        xs: ["0.75rem", { lineHeight: "1rem", letterSpacing: "2px" }],
